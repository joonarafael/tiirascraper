...
class HTMLParser:
    ...
    def parse(self):
        try:
            ...
            self.io.write(self.io_constants.BOLD + self.io_constants.FG_CYAN + "       Ensure the device has a working network connection!")
            self.io.write(self.io_constants.FG_CYAN + "       Retrying in 5 minutes.")
